...
var anthraciteTypography = function anthraciteTypography() {
  return {
    '@font-face': [{
      fontFamily: 'Nunito Sans',
      fontWeight: '300',
      src: ['url(\'' + NunitoSansLight2 + '\') format(\'woff2\')', 'url(\'' + NunitoSansLight + '\') format(\'woff\')', 'url(\'' + NunitoSansLightTtf + '\') format(\'truetype\')', 'url(\'' + NunitoSansLightEot + '\') format(\'embedded-opentype\')']
    }, {
      fontFamily: 'Nunito Sans',
      fontWeight: '400',
      src: ['url(\'' + NunitoSansRegular2 + '\') format(\'woff2\')', 'url(\'' + NunitoSansRegular + '\') format(\'woff\')', 'url(\'' + NunitoSansRegularTtf + '\') format(\'truetype\')', 'url(\'' + NunitoSansRegularEot + '\') format(\'embedded-opentype\')']
    }, {
      fontFamily: 'Nunito Sans',
      fontWeight: '700',
      src: ['url(\'' + NunitoSansBold2 + '\') format(\'woff2\')', 'url(\'' + NunitoSansBold + '\') format(\'woff\')', 'url(\'' + NunitoSansBoldTtf + '\') format(\'truetype\')', 'url(\'' + NunitoSansBoldEot + '\') format(\'embedded-opentype\')']
    }]
  };
};
