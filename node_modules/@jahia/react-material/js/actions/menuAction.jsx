...
var _componentRendererAction = require("./componentRendererAction");
var _composeActions = require("./composeActions");
var _DisplayActions = require("./DisplayActions");
var _withStylesAction = require("./withStylesAction");
...
var setActionsRef = function setActionsRef(ref, context) {
  if (ref) {
    ...
    menuStatus[context.id].menuSubscription = (0, _rxjs.combineLatest)(ref.observerRefs).subscribe(function () {
...
var preload = function preload(context) {
  context.obs = {
    enabled: new _rxjs.BehaviorSubject(false)
  };
  context.enabled = context.obs.enabled;
  var currentPreloadMenuHandler = context.renderComponent( /*#__PURE__*/_react["default"].createElement(_DisplayActions.DisplayActions, {
    target: context.menu,
...
var PureMenu = (0, _recompose.pure)(_core.Menu);
var display = function display(context, anchor) {
  ...
  var subMenuProps = context.parent ? {
    ...
    manager: new _core.ModalManager({
  ...
  context.currentMenuHandler = context.renderComponent( /*#__PURE__*/_react["default"].createElement(PureMenu, _extends({
    open: true,
  ...
  }, subMenuProps), /*#__PURE__*/_react["default"].createElement(_reactI18next.Translation, null, function (t) {
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, context.menuEmptyMessage && /*#__PURE__*/_react["default"].createElement(_core.MenuItem, {
      disabled: true,
      classes: {
        root: context.classes.emptyMenuItem
      }
    }, t(context.menuEmptyMessage)), /*#__PURE__*/_react["default"].createElement(_DisplayActions.DisplayActions, {
      ref: function ref(r) {
      ...
      render: function render(_ref) {
        ...
        }, showIcons && /*#__PURE__*/_react["default"].createElement(_designSystemKit.ListItemIcon, null, context.buttonIcon ? (0, _toIconComponent.toIconComponent)(context.buttonIcon) : /*#__PURE__*/_react["default"].createElement("span", {
...
var menuAction = (0, _composeActions.composeActions)(_componentRendererAction.componentRendererAction, (0, _withStylesAction.withStylesAction)(styles), {
  init: function init(context) {
    if (!context.icon) {
      context.icon = /*#__PURE__*/_react["default"].createElement(_icons.ArrowRight, null);
    }
