...
<head>
    <title>Code coverage report for getModuleFederationConfig.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> getModuleFederationConfig.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const camelCase = require('camelcase').default;
...
const getExtendedRange = (item, definedRange) =&gt; {
    if (compatRanges[item]) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (compatRange) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (definedRangeMatch &amp;&amp; compatRangeMatch) {
...
&nbsp;
    const name = config.name || camelCase((packageJson.name.indexOf('/') &gt; 0) ? packageJson.name.substring(packageJson.name.indexOf('/') + 1) : <span class="branch-1 cbranch-no" title="branch not covered" >packageJson.name)</span>;
&nbsp;
    return {
        ...config,
        name,
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed May 24 2023 16:15:59 GMT+0200 (Central European Summer Time)
            </div>
        </div>
