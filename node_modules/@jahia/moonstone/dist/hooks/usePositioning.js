...
export var usePositioning = function usePositioning(isDisplayed, anchorPosition, anchorEl, anchorElOrigin, transformElOrigin, position) {
  ...
  useEffect(function () {
    if (isDisplayed) {
      var resolvedAnchorEl = anchorEl && anchorEl.current ? anchorEl.current : anchorEl;
      var hasTransform = resolvedAnchorEl && resolvedAnchorEl.closest && resolvedAnchorEl.closest('[style*="transform"]');

      var _stylePosition = position === 'absolute' || hasTransform ? getAbsolutePosition(itemRef, anchorElOrigin, transformElOrigin, anchorPosition) : getFixedPosition(itemRef, anchorEl, anchorElOrigin, transformElOrigin, anchorPosition);
